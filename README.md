...
| [Filing Intelligence RAG](https://filing-intelligence-rag-7pj7nolpla-uc.a.run.app) | Evidence-first financial research across filings, earnings decks, and call transcripts. Quarter-aware retrieval produces source-linked answers with page and line provenance plus highlighted PDF verification. | FastAPI · ChromaDB · Sentence Transformers · Vertex AI · Streamlit · Cloud Run |
