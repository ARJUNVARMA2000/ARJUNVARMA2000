...
| [Airbnb Data Analyst Agent](https://github.com/ARJUNVARMA2000/airbnb-data-analyst-agent) · [Live demo](https://airbnb-frontend-686529012610.us-east1.run.app/) | Five specialized agents that plan, write, validate, chart, and narrate SQL analytics — every number is cited back to the source rows it came from. A validator agent catches failed queries and retries with corrected SQL. | FastAPI · LangChain · DuckDB / Postgres / Snowflake · OpenAI function calling · Matplotlib · pytest |
...
| [Filing Intelligence RAG](https://github.com/ARJUNVARMA2000/filing-intelligence-rag) · [Live demo](https://filing-intelligence-rag-7pj7nolpla-uc.a.run.app) | Evidence-first financial research across filings, earnings decks, and call transcripts. Quarter-aware retrieval produces source-linked answers with page and line provenance plus highlighted PDF verification. | Next.js · React · TypeScript · FastAPI · ChromaDB · Vertex AI · Cloud Run |
...
**ZS Associates** · Pune · Feb 2022 – Jun 2025  
Promoted Decision Analytics Associate → Associate Consultant → Advanced Data Science Associate Consultant in 4 cycles (typical: 5).
- Built an org-wide analytics/ML platform (Spark/SQL + dashboards) unifying 5+ data sources into territory and product KPIs for 100+ stakeholders on a $10B oncology portfolio; cut weekly reporting from days to minutes
- Engineered PySpark/SQL ETL pipelines spanning millions of patients for $4B+ oncology drug performance analytics
- Built PU-learning models for missing-label inference, lifting customer-journey analytics coverage from ~40% to ~95%
- Shipped drift monitoring and CI unit tests for production pipelines; led a 5-person team modernizing legacy business rules (~50 hrs/mo saved, >99% first-pass quality)
...
- **Columbia University** · M.S. Data Science · Aug 2025 – Dec 2026. TA for *Foundations of AI for Business* and *Hollywood & Big Data* at Columbia Business School.
- **Vellore Institute of Technology** · B.Tech Electronics & Communication Engineering (IoT and Sensors) · 2018 – 2022. Special Achiever Award · Merit Scholarship.
...
[av3342@columbia.edu](mailto:av3342@columbia.edu) · [LinkedIn](https://www.linkedin.com/in/varma-arjun/) · [arjun-varma.com](https://arjun-varma.com/)
